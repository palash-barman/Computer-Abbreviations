...
public class CustomAdaptor extends BaseExpandableListAdapter {

    private Context context;
    List<String> listDataHeader;
    HashMap<String,List<String>> listDataChild;

    public CustomAdaptor(Context context, List<String> listDataHeader, HashMap<String, List<String>> listDataChild) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
     ...
     TextView textView = view.findViewById(R.id.group_id);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view==null){
            ...
            view =  inflater.inflate(R.layout.chaild_layout,null);
        }
